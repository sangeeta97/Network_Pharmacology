...
edge_true= df1.describe()
edge_false= df22.describe()
edge_true.to_csv("edge_true.csv")
edge_false.to_csv("edge_false.csv")
...
def stripplot21():
    ...
    sns.stripplot(dfall['edge'], dfall['attachment'], palette = 'Dark2_r', size = 10)
...
def stripplot22():
    sns.set_context("talk", font_scale=1.4)
    plt.rcParams['figure.figsize'] = (18, 7)
    sns.stripplot(dfall['edge'], dfall['common'], palette = 'Dark2_r', size = 10)
...
def stripplot23():
    sns.set_context("talk", font_scale=1.4)
    plt.rcParams['figure.figsize'] = (18, 7)
    sns.stripplot(dfall['edge'], dfall['jc'], palette = 'Dark2_r', size = 10)
...
def stripplot24():
    sns.set_context("talk", font_scale=1.4)
    plt.rcParams['figure.figsize'] = (18, 7)
    sns.stripplot(dfall['edge'], dfall['resource'], palette = 'Dark2_r', size = 10)
...
def boxplot21():
    sns.set_context("talk", font_scale=1.4)
    plt.rcParams['figure.figsize'] = (18, 7)
    sns.boxenplot(dfall['edge'], dfall['attachment'], palette = 'Dark2_r')
    plt.title('edge type vs attachment Score', fontsize = 20)
...
def boxplot22():
    sns.set_context("talk", font_scale=1.4)
    plt.rcParams['figure.figsize'] = (18, 7)
    sns.boxenplot(dfall['edge'], dfall['common'], palette = 'Dark2_r')
    plt.title('edge type vs common_neigh Score', fontsize = 20)
...
def boxplot23():
    sns.set_context("talk", font_scale=1.4)
    plt.rcParams['figure.figsize'] = (18, 7)
    sns.boxenplot(dfall['edge'], dfall['jc'], palette = 'Dark2_r')
    plt.title('edge type vs jc Score', fontsize = 20)
...
def boxplot24():
    sns.set_context("talk", font_scale=1.4)
    plt.rcParams['figure.figsize'] = (18, 7)
    sns.boxenplot(dfall['edge'], dfall['resource'], palette = 'Dark2_r')
    plt.title('edge type vs resource Score', fontsize = 20)
